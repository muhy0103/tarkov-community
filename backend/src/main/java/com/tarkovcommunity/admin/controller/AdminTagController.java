...
public class AdminTagController {
    ...
    @GetMapping
    public ApiResponse<PageResponse<AdminTagResponse>> listTags(
        ...
        return ApiResponse.success(adminTagService.listTags(type, status, keyword, page, size));
    }
    ...
    public ApiResponse<AdminTagResponse> updateTag(
        ...
        return ApiResponse.success(adminTagService.updateTag(id, request));
    }
}
